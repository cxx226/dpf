...
from model.models import ImplicitGuideDPT
...
def train_seg(local_rank, args):
    ...
    single_model = ImplicitGuideDPT(num_classes)
...
def test_seg(args):
    ...
    if len(task_list) == 1:
        single_model = ImplicitGuideDPT(num_classes, backbone="vitb_rn50_384")
    else:
        single_model = ImplicitGuideDPT(num_classes, task_list, backbone="vitb_rn50_384")
